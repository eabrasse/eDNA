...
axu.text(0.35,0.9,'Eliz exctraction @ Bangor',transform=axu.transAxes,color=Bang['col'],fontsize=10)
axu.text(0.35,0.81,'Jilian exctraction @ Bangor',transform=axu.transAxes,color=modJcol,fontsize=10)
