...
xymax = 100*max([np.percentile(rt['hist_nodecay'],95) for rt in release_type_list])
...
#plt.show()
fig1.subplots_adjust(bottom=0.08,top=0.98,left=0.08,right=0.98,hspace=0.2)
outfn1 = '/data2/pmr4/eab32/etools/plots/hc_dolph_3d_compare_releases_heatmap.png'
fig1.savefig(outfn1)
print('saved to {}'.format(outfn1))
fig2.subplots_adjust(bottom=0.08,top=0.98,left=0.08,right=0.98,hspace=0.2)
