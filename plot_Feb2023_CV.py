...
for relstrat in relstrat_list:
    relstrat['mean'] = np.nanmean(relstrat['particle_bin'][relstrat['particle_bin']>0],axis=0)
    relstrat['std'] = np.nanstd(relstrat['particle_bin'][relstrat['particle_bin']>0],axis=0)
