...
start_mask = np.isnan(lon[0,:])
ax.plot(lon[0,start_mask], lat[0,start_mask], 'kx', alpha=1,markersize=2)
ax.plot(lon[0,~start_mask], lat[0,~start_mask], 'og', alpha=1,markersize=2)
...
#plt.show()
outfn = '/data2/pmr4/eab32/etools/plots/hc_dolph_surf_sh1_10k_start_mask.png'
plt.savefig(outfn)
pfun.end_plot()
