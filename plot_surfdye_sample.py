...
# indpairs = list(zip(xinds_array.flatten(),yinds_array.flatten()))
# countpairs = list(zip(xcount_array.flatten(),ycount_array.flatten()))
# nstations = int(ni*nj)
...
fig1 = plt.figure(figsize=(fw*3,fh*1.5))
gs = GridSpec(nj,int(2*ni))
# fig2 = plt.figure(figsize=(fw*12,fh*0.5))

axmap = fig1.add_subplot(gs[:,:(ni-1)])
